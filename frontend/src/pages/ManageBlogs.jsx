...
const ManageBlogs = () => {
  ...
  const fetchMyBlogs = async () => {
    try {
      ...
      const { data } = await axios.get(`${import.meta.env.VITE_PUBLIC_BACKEND_URL}/blog/user`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingBlog
        ? `${import.meta.env.VITE_PUBLIC_BACKEND_URL}/blog/${editingBlog._id}`
        : `${import.meta.env.VITE_PUBLIC_BACKEND_URL}/blog`;
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(`${import.meta.env.VITE_PUBLIC_BACKEND_URL}/blog/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
